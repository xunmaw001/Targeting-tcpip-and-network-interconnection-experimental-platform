<template>
  <div :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}'>
    <el-form
      ...
      label-width="180px"
    >
      <el-form-item :style='{"margin":"0 0 20px 0"}' label="选择实验题目" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择实验题目">
          <el-option
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择实验题目", trigger: "blur" }],
        questionname: [
