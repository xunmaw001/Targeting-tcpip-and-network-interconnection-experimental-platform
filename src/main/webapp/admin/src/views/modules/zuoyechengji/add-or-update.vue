	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="作业分数" prop="zuoyefenshu">
					<el-input v-model="ruleForm.zuoyefenshu" placeholder="作业分数" clearable  :readonly="ro.zuoyefenshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="作业分数" prop="zuoyefenshu">
					<el-input v-model="ruleForm.zuoyefenshu" placeholder="作业分数" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="评分日期" prop="pingfenriqi">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.pingfenriqi" label="评分日期" prop="pingfenriqi">
