<template>
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="实验题目名称" prop="name">
					<el-input v-model="ruleForm.name" placeholder="实验题目名称" clearable  :readonly="ro.name"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="实验题目名称" prop="name">
					<el-input v-model="ruleForm.name" placeholder="实验题目名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="考试时长(分钟)" prop="time">
					<el-input v-model="ruleForm.time" placeholder="考试时长(分钟)" clearable  :readonly="ro.time"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="考试时长(分钟)" prop="time">
					<el-input v-model="ruleForm.time" placeholder="考试时长(分钟)" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="实验题目状态" prop="status">
					<el-select :disabled="ro.status" v-model="ruleForm.status" placeholder="请选择实验题目状态" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="实验题目状态" prop="status">
					<el-input v-model="ruleForm.status?'启用':'禁用'" 
						placeholder="实验题目状态" readonly></el-input>
				</el-form-item>
			</template>
...
export default {
	data() {
		...
		return {
			...
			rules: {
				name: [
					{ required: true, message: '实验题目名称不能为空', trigger: 'blur' },
				],
				time: [
				...
				status: [
					{ required: true, message: '实验题目状态不能为空', trigger: 'blur' },
					{ validator: validateIntNumber, trigger: 'blur' },
				],
			}
		};
