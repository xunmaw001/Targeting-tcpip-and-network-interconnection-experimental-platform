	...
	<div class="addEdit-block" :style='{"padding":"10px 30px 30px","background":"url(http://codegen.caihongy.cn/20230228/47752d6be3a94e8892a83ec2a70c8443.png)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="布置时间" prop="buzhishijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.buzhishijian" label="布置时间" prop="buzhishijian">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.zuoyeneirong = this.ruleForm.zuoyeneirong.replace(reg,'../../../ssmji1s8/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
