...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"2"}'>
      ...
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>互评姓名</div>
        <el-input v-model="formSearch.hupingxingming" placeholder="互评姓名" clearable></el-input>
      </el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.hupingxingming != '') searchWhere.hupingxingming = '%' + this.formSearch.hupingxingming + '%';
        this.$http.get('xueshenghuping/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/xueshenghupingDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
