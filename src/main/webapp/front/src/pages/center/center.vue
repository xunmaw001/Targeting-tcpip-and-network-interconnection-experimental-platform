    ...
    <el-tabs tab-position="left" :style='{"border":"0","padding":"20px","margin":"0","borderRadius":"0 0 16px 16px","background":"none"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          ...
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' v-if="userTableName=='xuesheng'" label="班级">
            <el-select v-model="sessionForm.banji" placeholder="请选择班级" >
              <el-option v-for="(item, index) in dynamicProp.banji" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' v-if="userTableName=='laoshi'" label="老师账号" prop="laoshizhanghao">
            <el-input v-model="sessionForm.laoshizhanghao" placeholder="老师账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' v-if="userTableName=='laoshi'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' v-if="userTableName=='laoshi'" label="老师姓名" prop="laoshixingming">
            <el-input v-model="sessionForm.laoshixingming" placeholder="老师姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' v-if="userTableName=='laoshi'" label="年龄" prop="nianling">
            <el-input v-model="sessionForm.nianling" placeholder="年龄" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' v-if="userTableName=='laoshi'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' v-if="userTableName=='laoshi'" label="联系电话" prop="lianxidianhua">
            <el-input v-model="sessionForm.lianxidianhua" placeholder="联系电话" ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' v-if="userTableName=='laoshi'" label="班级">
            <el-select v-model="sessionForm.banji" placeholder="请选择班级" >
              <el-option v-for="(item, index) in dynamicProp.banji" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"border":"1px solid #dfdfdf","padding":"10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 10px","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)"}' v-if="userTableName=='laoshi'" label="头像">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
  ...
  export default {
    ...
    created() {
      ...
      if ('laoshi' == this.userTableName) {
        this.$set(this.sessionForm, 'laoshizhanghao', null);
      }
      if ('laoshi' == this.userTableName) {
        this.$set(this.sessionForm, 'mima', null);
      }
      ...
      if ('laoshi' == this.userTableName) {
        this.$set(this.rules, 'laoshizhanghao', [{ required: true, message: '请输入老师账号', trigger: 'blur' }]);
      }
      if ('laoshi' == this.userTableName) {
        this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
      }
      ...
      init() {
        ...
        if ('xuesheng' == this.userTableName) {
          this.$http.get('option/banjixinxi/banji', {emulateJSON: true}).then(res => {
            if (res.data.code == 0) {
              this.dynamicProp.banji = res.data.data;
            }
          });
        }
        if ('laoshi' == this.userTableName) {
